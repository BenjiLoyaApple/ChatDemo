...
struct DeviceInfo {
    static func deviceDetails() -> [String: String] {
        ...
        details["Model"] = device.model // "iPhone"
        details["System Name"] = device.systemName //  "iOS"
        details["System Version"] = device.systemVersion // "17.2"
        
        // Экран
        let screen = UIScreen.main
        details["Screen Size"] = "\(Int(screen.bounds.width)) x \(Int(screen.bounds.height))"
        details["Screen Scale"] = "\(screen.scale)x"
